        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-lg text-slate-600">
              Опытные подологи, врач-остеопат и реабилитолог работают в одном центре, чтобы предложить комплексный
              подход к здоровью стоп, опорно-двигательной системы и восстановлению после травм.
            </p>
          </div>
        </div>
      </section>
