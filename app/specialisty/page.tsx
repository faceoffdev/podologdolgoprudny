...
export const metadata: Metadata = {
  ...
  description:
    'Команда центра: подологи, врач ортопед-остеопат, врач-реабилитолог и специалист по лечебному массажу. Выберите специалиста и перейдите к его услугам и ценам.',
  alternates: {
  ...
  openGraph: {
    title: 'Специалисты центра подологии и остеопатии',
    description:
      'Подологи, врач ортопед-остеопат, врач-реабилитолог и специалист по лечебному массажу. Детальные профили специалистов и услуги.',
    url: '/specialisty/',
    type: 'website',
  },
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-lg text-slate-600">
              Врачи и специалисты центра ведут приём по подологии, ортониксии, озонотерапии, остеопатии и лечебному
              массажу. На странице каждого специалиста доступны профиль, услуги и цены.
            </p>
          </div>
        </div>
      </section>
