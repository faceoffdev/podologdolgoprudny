        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base sm:text-lg text-slate-600 max-w-4xl">
              На сайте указаны диапазоны цен по специалистам. Итоговая стоимость зависит от клинической картины,
              объёма процедуры и необходимости дополнительных манипуляций.
            </p>
          </div>
        </div>
      </section>
