			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">
						Наши специалисты в Долгопрудном
					</h2>
					<p className="text-lg text-slate-600">
						Опытные подологи и врач-остеопат ведут приём в центре подологии и остеопатии. Помогаем с
						проблемами стоп, ногтей и болевыми синдромами, подбираем индивидуальные решения и план лечения.
					</p>
				</motion.div>
