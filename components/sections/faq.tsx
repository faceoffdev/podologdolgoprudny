...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'В центре доступны подология, ортониксия, лечение вросшего ногтя, озонотерапия, плазмодинамическое воздействие, остеопатия и лечебный массаж. Полный перечень и цены размещены в разделе «<a href="/uslugi/" class="hover:underline">Услуги</a>».',
  },
  {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8">
              Ответы на частые вопросы о приёме, услугах, ценах и формате консультаций. Если нужна дополнительная
              информация, свяжитесь с нами по телефону.
            </p>
