			...
			<div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="grid lg:grid-cols-2 gap-12 lg:gap-8 lg:items-center min-h-screen py-0">
					...
					>
						...
						>
							Ведущий подолог и организатор центра{' '}
							<span className="text-primary">Солоха Татьяна Викторовна</span>
						</motion.h1>
						...
						>
							Подологическая практика: медицинский педикюр, коррекция ногтей, лечение вросшего ногтя,
							удаление мозолей и трещин, а также остеопатический приём. Принимаем взрослых и детей по записи.
						</motion.p>
