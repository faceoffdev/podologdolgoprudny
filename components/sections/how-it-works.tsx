...
const steps = [
  {
    ...
    description:
      'Выберите из нашего широкого спектра медицинских услуг ту, которая лучше всего соответствует вашим потребностям.',
  },
  {
    icon: ClipboardCheck,
    number: '02',
    title: 'Выбрать дату и время',
    description: 'Выберите удобную дату и время, которые подходят вам по графику.',
  },
  {
    icon: Stethoscope,
    number: '03',
    title: 'Получить лечение',
    description: 'Посетите наш центр и получите квалифицированную помощь от наших специалистов.',
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">
              Запишитесь на прием в несколько простых шагов
            </h2>
            <p className="text-lg text-slate-600 mb-10">
              Получить необходимую медицинскую помощь стало как никогда просто. Следуйте этим простым шагам, чтобы
              записаться на приём и начать путь к улучшению своего здоровья.
            </p>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Выберете удобное для вас время</p>
                    </div>
                  </div>
