...
const steps = [
  {
    ...
    description:
      'Выберите подходящую услугу в каталоге: подология, ортониксия, лечение вросшего ногтя, озонотерапия, остеопатия и другие направления.',
  },
  {
    icon: ClipboardCheck,
    number: '02',
    title: 'Выбрать дату и время',
    description: 'Запишитесь на удобные дату и время онлайн или по телефону. Администратор подтвердит запись и ответит на вопросы.',
  },
  {
    icon: Stethoscope,
    number: '03',
    title: 'Прийти на приём',
    description: 'На приёме специалист проведёт осмотр, выполнит процедуру и даст рекомендации по дальнейшему уходу.',
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">
              Запись на приём в центр — 3 простых шага
            </h2>
            <p className="text-lg text-slate-600 mb-10">
              Выберите услугу, удобное время и приходите на приём. Все этапы записи прозрачны и занимают минимум
              времени.
            </p>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Врач-реабилитолог</p>
                    </div>
