...
export const doctors: DoctorProfile[] = [
  ...
  },
  {
    ...
    services: [
      ...
      'Аппаратная чистка поврежденных ногтевых пластин со спреем',
      'Обработка натоптышей и трещин',
      'Работа с деформациями ногтей',
    ],
    education: [],
  ...
  },
  {
    ...
    services: [
      'Коррекция нарушений осанки у подростков и взрослых',
      'Диагностика стоп и изготовление индивидуальных ортезов Формтотикс',
      'Коррекция двигательных навыков спортсменов и любителей',
      'Лечение болевых синдромов разной локализации',
      'Реабилитация после травм, инсультов и инфарктов',
    ],
    education: [
  ...
  },
  {
    ...
    services: [
      'Лечебный массаж спины и шейно-воротниковой зоны',
      'Снятие мышечного напряжения и спазмов',
      'Восстановительный массаж после нагрузок',
      'Профилактические курсы для улучшения подвижности',
    ],
    education: [
      {
        year: '1995',
