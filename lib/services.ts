...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription:
      'Установка корректирующей системы для деликатного выравнивания ногтевой пластины и профилактики повторного врастания.',
    description: [
      'Скоба 3TO представляет собой трехкомпонентную коррекционную систему для лечения вросшего или деформированного ногтя. Она состоит из двух скоб и стягивающего зажима, которые устанавливаются на ногтевую пластину для постепенного выравнивания ее роста.',
    ...
    images: [
      {
        ...
        alt: 'Вид услуги: Установка скобы 3TO',
      },
    ],
  },
  {
