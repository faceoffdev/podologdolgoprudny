...
export const serviceCategories: ServiceCategory[] = [
  {
    slug: 'podologiya',
    name: 'Подология',
    description: 'Услуги категории «Подология».',
  },
  {
    slug: 'ortoniksiya',
    name: 'Ортониксия',
    description: 'Услуги категории «Ортониксия».',
  },
  {
    slug: 'vrosshiy-nogot',
    name: 'Вросший ноготь',
    description: 'Услуги категории «Вросший ноготь».',
  },
  {
    slug: 'onihomikoz-dermatomikoz',
    name: 'Онихомикоз. Дерматомикоз',
    description: 'Услуги категории «Онихомикоз. Дерматомикоз».',
  },
  {
    slug: 'ozonoterapiya',
    name: 'Озонотерапия',
    description: 'Услуги категории «Озонотерапия».',
  },
  {
    slug: 'plazmodinamicheskoe-vozdeystvie-gelios',
    name: 'Плазмодинамическое воздействие (аппарат «Гелиос»)',
    description: 'Услуги категории «Плазмодинамическое воздействие (аппарат «Гелиос»)».',
  },
  {
    slug: 'osteopatiya',
    name: 'Остеопатия',
    description: 'Услуги категории «Остеопатия».',
  },
  {
    slug: 'massazh',
    name: 'Массаж',
    description: 'Услуги категории «Массаж».',
  },
  {
    slug: 'uhod-za-rukami',
    name: 'Уход за руками',
    description: 'Услуги категории «Уход за руками».',
  },
  {
    slug: 'vyezd-na-dom-k-patsientu',
    name: 'Выезд на дом к пациенту',
    description: 'Услуги категории «Выезд на дом к пациенту».',
  },
  {
    slug: 'kosmetologiya-trihologiya',
    name: 'Косметология/трихология',
    description: 'Услуги категории «Косметология/трихология».',
  },
  {
    slug: 'girudoterapiya',
    name: 'Гирудотерапия',
    description: 'Услуги категории «Гирудотерапия».',
  },
]
...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: [
      'Услуга «Наложение фиксирующего композита» выполняется после осмотра и направлена на аккуратное устранение текущей проблемы в зоне обращения.',
  ...
  },
  {
    ...
    description: [
      'Услуга «Установка Титановой нити» применяется при деформации ногтя и склонности к врастанию, когда необходима длительная коррекция.',
      'Во время процедуры специалист фиксирует систему с учетом анатомии ногтя и текущего состояния тканей.',
      'Дальнейшее ведение включает контрольные визиты и коррекции для достижения стабильного результата.',
    ],
    duration: '30 минут',
  ...
  },
  {
    ...
    shortDescription:
      'Установка корректирующей системы для деликатного выравнивания ногтевой пластины и профилактики повторного врастания.',
    description: [
      'Услуга «Установка скобы Фрезера» применяется при деформации ногтя и склонности к врастанию, когда необходима длительная коррекция.',
      'Во время процедуры специалист фиксирует систему с учетом анатомии ногтя и текущего состояния тканей.',
      'Дальнейшее ведение включает контрольные визиты и коррекции для достижения стабильного результата.',
    ],
    duration: '1 ч',
  ...
  },
  {
    ...
    name: 'Установка скобы 3TO',
    categorySlug: 'ortoniksiya',
    shortDescription:
      'Установка корректирующей системы для деликатного выравнивания ногтевой пластины и профилактики повторного врастания.',
    description: [
      'Услуга «Установка скобы 3TO» применяется при деформации ногтя и склонности к врастанию, когда необходима длительная коррекция.',
      'Во время процедуры специалист фиксирует систему с учетом анатомии ногтя и текущего состояния тканей.',
      'Дальнейшее ведение включает контрольные визиты и коррекции для достижения стабильного результата.',
    ],
    duration: '1 ч',
  ...
  },
  {
    ...
    shortDescription:
      'Первичная обработка. Данная процедура включает обработку стоп и глубокую чистку ногтей, поврежденных микозом.',
    description: [
  ...
  },
  {
    ...
    categorySlug: 'vrosshiy-nogot',
    shortDescription:
      'Манипуляция рассчитана на пациентов после удаления вросших сегментов ногтя. назначается на 3 день и далее по необходимости.',
    description: [
  ...
  },
  {
    ...
    categorySlug: 'plazmodinamicheskoe-vozdeystvie-gelios',
    shortDescription:
      'Воздействие плазменным лучом на корень ногтя, ложе (после чистки), стимуляция процессов регенерации, восстановление качества ногтевой пластины. Область примения: псориаз ногтей, онихомикоз, онихолизис, ожоги ногтевых пластин в т.ч. после химиотерапии.',
    description: [
  ...
  },
  {
    ...
    categorySlug: 'ozonoterapiya',
    shortDescription:
      'Инъекционное введеннние озоно-кислородной смеси в проблемные зоны. Периодичность 1-2 раза в неделю, по схеме 2 раза в год.',
    description: [
  ...
  },
  {
    ...
    categorySlug: 'ozonoterapiya',
    shortDescription:
      'Глобальное омоложение организма, подавление всех воспалительных процессов, активизация собственного иммунитета.',
    description: [
      'Процедура выполняется методом 3х игл.В вену вводится физраствор, обогащенный озоно-кислородной смесью. Терапевтический эффект 6-8 процедур, 1-2 раза в неделю, 2 раза в год.',
    ],
    duration: '1 ч',
  ...
  },
  {
    ...
    description: [
      ...
      'Такой протокол обеспечивает выраженный лимфодренаж, улучшение микроциркуляции, выравнивание рельефа и повышение тонуса кожи лица, а при необходимости и кожи головы.',
      'Состав активных средств и параметры каждого этапа подбираются специалистом индивидуально для достижения максимально стабильного результата.',
    ],
    duration: '55 минут',
  ...
  },
  {
    ...
    shortDescription:
      'Гирудотерапия для улучшения микроциркуляции, снижения отечности и воспалительной нагрузки, а также поддержки восстановительных процессов.',
    description: [
      'Гирудотерапия проводится с использованием медицинских пиявок и применяется как метод дополнительной терапии при ряде состояний по назначению специалиста.',
      'Биоактивные компоненты секрета пиявки способствуют улучшению микроциркуляции, уменьшению отечности и снижению выраженности воспалительных проявлений.',
      'Количество сеансов, зоны постановки и интервалы между процедурами подбираются индивидуально после очной оценки показаний и противопоказаний.',
    ],
    duration: '1 ч 30 минут',
