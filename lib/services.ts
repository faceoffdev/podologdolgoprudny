...
export const serviceCategories: ServiceCategory[] = [
  {
    slug: 'podologiya',
    name: 'Подология',
    description: 'Диагностика, обработка и уход при проблемах стоп и ногтей.',
  },
  {
    slug: 'ortoniksiya',
    name: 'Ортониксия',
    description: 'Коррекция формы ногтя с помощью скоб и титановой нити.',
  },
  {
    slug: 'vrosshiy-nogot',
    name: 'Вросший ноготь',
    description: 'Процедуры для снижения боли, воспаления и профилактики рецидива.',
  },
  {
    slug: 'onihomikoz-dermatomikoz',
    name: 'Онихомикоз. Дерматомикоз',
    description: 'Подологическая обработка и сопровождение при грибковых поражениях.',
  },
  {
    slug: 'ozonoterapiya',
    name: 'Озонотерапия',
    description: 'Озонотерапевтические процедуры для локального и системного воздействия.',
  },
  {
    slug: 'plazmodinamicheskoe-vozdeystvie-gelios',
    name: 'Плазмодинамическое воздействие (аппарат «Гелиос»)',
    description: 'Аппаратные протоколы для восстановления и улучшения качества кожи и ногтей.',
  },
  {
    slug: 'osteopatiya',
    name: 'Остеопатия',
    description: 'Консультации и коррекционные процедуры врача ортопеда-остеопата.',
  },
  {
    slug: 'massazh',
    name: 'Массаж',
    description: 'Лечебный массаж для снижения мышечного напряжения и боли.',
  },
  {
    slug: 'uhod-za-rukami',
    name: 'Уход за руками',
    description: 'Гигиенические и аппаратные процедуры для кожи и ногтей рук.',
  },
  {
    slug: 'vyezd-na-dom-k-patsientu',
    name: 'Выезд на дом к пациенту',
    description: 'Подологическая помощь на дому для пациентов с ограниченной мобильностью.',
  },
  {
    slug: 'kosmetologiya-trihologiya',
    name: 'Косметология/трихология',
    description: 'Аэродинамические процедуры для кожи лица и волосистой части головы.',
  },
  {
    slug: 'girudoterapiya',
    name: 'Гирудотерапия',
    description: 'Гирудотерапия по показаниям в рамках комплексной терапии.',
  },
]
...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription:
      'Первичная процедура с обработкой стоп и глубокой чисткой ногтей, поврежденных микозом.',
    description: [
